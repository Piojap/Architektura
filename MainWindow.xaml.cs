...
//HEX VALUES GENERATOR
        private void GenerateHex()
        {
            ...
            AX.Text = generate.Next(0, 65535).ToString("X");
            BX.Text = generate.Next(0, 65535).ToString("X");
            CX.Text = generate.Next(0, 65535).ToString("X");
            DX.Text = generate.Next(0, 65535).ToString("X");
        }
//RESET REGISTERS
        private void Reset()
        {
...
//GENERATE BUTTON REF
        private void GenerateHexButton(object sender, EventArgs e)
        {
            GenerateHex();
        }
//RESET BUTTON REF
        private void ResetRegistersButton(object sender, EventArgs e)
        {
            Reset();
        }
//MOVE BUTTON REF
